...
public class Character {
	...
	private JLabel rabbitright = new JLabel("img/character/rabbitright.png");
	private JLabel bearright= new JLabel("img/character/bearright.png");
	private JLabel astronautright= new JLabel("img/character/astronautright.png");  
	
	private JLabel catleft = new JLabel("img/character/catleft.png");
	private JLabel rabbitleft = new JLabel("img/character/rabbitleft.png");
	private JLabel bearleft = new JLabel("img/character/bearleft.png");
	private JLabel astronautleft = new JLabel("img/character/astronautleft.png"); 
